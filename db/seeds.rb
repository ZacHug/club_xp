...
club1 = Club.create!(
    name: "BLVD44",
    address: "2108 Blvd St Laurent Montreal, QC",
...
club3 = Club.create!(
    name: "Muzique",
    address: "3781 St Laurent Blvd, Montreal, QC",
...
club4 = Club.create!(
    ...
    address: "858 St Catherine St E, Montreal, QC",
...
club5 = Club.create!(
    ...
    address: "3500 St Laurent Blvd, Montreal, QC",
...
club6 = Club.create!(
    name: "Mme Lee",
    address: "151 Ontario St E, Montreal, QC",
...
club7 = Club.create!(
    name: "IVY Nightclub",
    address: " 3556 St Laurent Blvd, Montreal, QC",
...
club8 = Club.create!(
    name: "Balattou Club",
    address: "4372 St Laurent Blvd, Montreal, QC",
...
club9 = Club.create!(
    name: "Le Belmont",
    address: "4483 St Laurent Blvd, Montreal, QC",
...
club10 = Club.create!(
    name: "Le Salon Daomé",
    address: "4465 St Laurent Blvd, Montreal, QC",
